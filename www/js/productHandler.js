var productHandler={
addProduct: function(name, type, dateTime, price, note, nameReport, serviceRating , cleanRating , foodRating, image ){
    databaseHandler2.db.transaction(
        function(tx){
            tx.executeSql(
                "insert into product(name, type, bussinesstime, price, note, namereport, service_rating , cleanning_rating , food_rating, image) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                [name, type, dateTime, price, note, nameReport, serviceRating , cleanRating , foodRating, image],
                function(tx, results){},
                function(tx, error){
